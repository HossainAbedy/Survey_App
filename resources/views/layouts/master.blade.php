...
<html lang="en">
    ...
    <body class="hold-transition sidebar-mini">
        ...
        <footer class="main-footer">
            ...
            Anything you want, Everything you get
            </div>
            <!-- Default to the left -->
            <strong>Copyright &copy; 2014-2019 <a href="https://hossainabedy.github.io/Portfolio">Hossain Abedy</a>.</strong> All rights reserved.
        </footer>
        </div>
